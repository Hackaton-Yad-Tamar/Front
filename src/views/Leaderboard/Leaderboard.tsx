    ...
    >
      {achievements.map((achievement, index) => (
        ...
        >
          ...
          <Typography fontSize="0.9rem" color="gray.600">
            {achievement.volunteer_name}
          </Typography>
          <Typography
            fontSize="1.5rem"
            fontWeight="bold"
...
const StoryCarousel = () => {
  ...
  const family_names = ["ברנשטיין", "לוי", "רוזן", "כהן"];
  ...
  return (
    <Box display="flex" alignItems="center" justifyContent="center" p={4}>
      ...
      <Box sx={{ maxWidth: 500, textAlign: "center" }}>
        ...
        <Typography variant="body1">{stories[currentIndex]}</Typography>
      </Box>
    ...
    <Container sx={{ flexGrow: 1, my: 6, direction: "rtl" }}>
      ...
      <Box>
        ...
        <Typography variant="body1" textAlign="center" gutterBottom fontSize={25} lineHeight={2}>
          ביישוב קטן בגליל, שבו הקהילה הייתה כמו משפחה אחת גדולה, התאספו התושבים לערב מיוחד במינו -
          ערב התרמה למען משפחות שכולות שאיבדו את יקיריהן במערכות ישראל. היוזמה יצאה מקבוצת תלמידי
          תיכון מקומי, שרצו לעשות מעשה משמעותי לזכר אחד מבני היישוב שנפל בקרב. הם פנו לראש המועצה
          והציעו להפיק אירוע שכל הכנסותיו יוקדשו לקרן סיוע למשפחות השכולות. תוך ימים ספורים, כל
          היישוב התגייס - בעלי עסקים תרמו פרסים להגרלה, מסעדות מקומיות סיפקו אוכל בהתנדבות, ולהקת
          הנוער של המתנ"ס החלה בחזרות למופע מרגש. בערב האירוע, האולם היה מלא עד אפס מקום. על הבמה
          הוקרנו סרטונים על הנופלים, וקרובי משפחה שיתפו סיפורים אישיים. אחד הרגעים המרגשים היה כשאמו
          של חייל שנפל סיפרה כיצד התמיכה הקהילתית עזרה לה לקום מחדש. לאחר מופע מרגש של להקת הנוער,
          התקיימה מכירה פומבית שבה נמכרו יצירות של אמנים מקומיים, וחלק מהפריטים הוענקו כמתנה למשפחות
          השכולות. עד סוף הערב, הצליחו לגייס סכום מרשים, הרבה מעבר לציפיות. אך מעבר לכסף שנאסף,
          האירוע הותיר רושם עמוק על כל המשתתפים. הוא הוכיח את כוחה של קהילה, את הערבות ההדדית ואת
          היכולת להפוך כאב לאור של נתינה ואהבה.
        </Typography>
        <Box>
