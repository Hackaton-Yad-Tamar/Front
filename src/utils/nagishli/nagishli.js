...
function initNagishLi() {
    ...
    function f(a, d, e) {
        ...
        if (-1 !== ["change", "read", "delete"].indexOf(a)) {
            ...
            "change" == a
                ? ((f[d] = "object" === typeof e ? f[d].substring(0, e.pos) + e.to + f[d].substring(e.pos + 1) : e), localStorage.setItem("Localize-NagishLi-A11y-Plugin-Settings", JSON.stringify(f)))
    ...
    if (!K && m) {
        ...
        -1 != m.indexOf("|")
            ...
            ? (v = m.replace("p:", ""))
            : -1 != m.indexOf("u:")
            ? (u = -1 != m.indexOf("d:") ? m.replace("+", "@").replace("u:", "").replace("d:", "") : m.replace("u:", "") + "@" + D)
                  ...
                  accessibility_statement:
                      ...
                      (m
                          ? "\u05d0\u05dd \u05d9\u05e9 \u05dc\u05da \u05e9\u05d0\u05dc\u05d5\u05ea \u05d0\u05d5 \u05d4\u05e2\u05e8\u05d5\u05ea \u05db\u05dc\u05e9\u05d4\u05df \u05dc\u05d2\u05d1\u05d9 \u05d4\u05e0\u05d2\u05d9\u05e9\u05d5\u05ea \u05e9\u05dc \u05d0\u05ea\u05e8 \u05d6\u05d4, \u05d1\u05d0\u05e4\u05e9\u05e8\u05d5\u05ea\u05da \u05dc\u05d9\u05e6\u05d5\u05e8 \u05e7\u05e9\u05e8:<br /><br />" +
                            (p ? "\u05de\u05de\u05d5\u05e0\u05d4 \u05e2\u05dc \u05d4\u05e0\u05d2\u05d9\u05e9\u05d5\u05ea: " + p + "<br />" : "") +
                            (v ? "\u05d8\u05dc\u05e4\u05d5\u05df: " + v + "<br />" : "") +
                            (u ? '\u05d3\u05d5\u05d0\u05e8 \u05d0\u05dc\u05e7\u05d8\u05e8\u05d5\u05e0\u05d9: <a href="mailto:' + u + '">' + u + "</a><br />" : "") +
                            (z ? "\u05e4\u05e7\u05e1: " + z + "<br />" : "") +
                            "<br />"
                          : "") +
    ...
    $NagishLi(function (a) {
            ...
            if (a("body").attr("nl-colors") != c) {
                if (
                    ("custom" == a("body").attr("nl-colors") &&
                        ...
                        a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.bg + "'] > li[aria-label='" + phrases.clr_custom + "'] > input#NLColorPicker").attr(
                            "value",
                            h(a("body").css("background-color"))
                        ),
                        a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "'] > input#NLColorPicker").attr(
                            "value",
                            h(a("body").css("color"))
                        ),
                        a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.bg + "'] > li[aria-label='" + phrases.clr_custom + "']")
                            .attr("aria-label", phrases.aria_select_bgcolor)
                            .css("background-color", a("body").css("background-color")),
                        a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "']")
                            .attr("aria-label", phrases.aria_select_txtcolor)
                            .css("color", a("body").css("color"))),
                    "100%" != a("html").css("height") && a("html").css("height", "100%"),
                    a(":root").css({ filter: "grayscale(100%)", "-webkit-filter": "grayscale(100%)", "-khtml-filter": "grayscale(100%)", "-ms-filter": "grayscale(100%)", "-o-filter": "grayscale(100%)", "-moz-filter": "grayscale(100%)" }),
                    a("body").attr("nl-colors", c),
                    b)
                )
                    return (
                        a(commons.dd + " > #NagishLiColors > li > #NLGrayscaleColors")
                            .attr("aria-label", phrases.aria_the_option + phrases.blind + " " + phrases.r2m_on)
                ...
                if (
                    ("custom" == a("body").attr("nl-colors") &&
                        ...
                        a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "']")
                            ...
                            .css("color", a("body").css("color"))),
                    "100%" != a("html").css("height") && a("html").css("height", "100%"),
                    a(":root").css({ filter: "invert(100%)", "-webkit-filter": "invert(100%)", "-khtml-filter": "invert(100%)", "-ms-filter": "invert(100%)", "-o-filter": "invert(100%)", "-moz-filter": "invert(100%)" }),
                    a("body").attr("nl-colors", c),
                    b)
                )
                    return (
                        a(commons.dd + " > #NagishLiColors > li > #NLInvertColors")
                            .attr("aria-label", phrases.aria_the_option + phrases.impaired + " " + phrases.r2m_on)
                            .prepend(commons.checkmark)
                            .parent("li")
                            .addClass("active")
                            .siblings("li")
                    ...
                    return (
                        "warm" == b
                            ? (a(commons.dd + " > #NagishLiColors > li > #NLWarmColors")
                                  .attr("aria-label", phrases.aria_the_option + phrases.bl_filter + " " + phrases.r2m_on)
                                  .prepend(commons.checkmark)
                                  .parent("li")
                                  .addClass("active")
                                  .siblings("li")
                              ...
                              a(commons.dd + " > #NagishLiColors")
                                  .prev("div.nl-dropdown-toggle")
                                  .hasClass("open") ||
                                  a('<span class="selected">' + phrases.bl_filter + "</span>").insertAfter(
                                      a(commons.dd + " > #NagishLiColors")
                                          .prev("div", ".nl-dropdown-toggle")
                                          .children(".nl-dropdown-title")
                                  ))
                            : (a(commons.dd + " > #NagishLiColors > li > #NLColdColors")
                                  .attr("aria-label", phrases.aria_the_option + phrases.lc_filter + " " + phrases.r2m_on)
                                  .prepend(commons.checkmark)
                                  .parent("li")
                                  .addClass("active")
                                  .siblings("li")
                              ...
                              a(commons.dd + " > #NagishLiColors")
                                  .prev("div.nl-dropdown-toggle")
                                  .hasClass("open") ||
                                  a('<span class="selected">' + phrases.lc_filter + "</span>").insertAfter(
                                      a(commons.dd + " > #NagishLiColors")
                                          .prev("div", ".nl-dropdown-toggle")
                                          .children(".nl-dropdown-title")
                                  )),
                ...
                if (
                    ("custom" == a("body").attr("nl-colors") &&
                        ...
                        a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "']")
                            ...
                            .css("color", a("body").css("color"))),
                    "100%" != a("html").css("height") && a("html").css("height", "100%"),
                    a(":root").css({ filter: "saturate(800%)", "-webkit-filter": "saturate(800%)", "-khtml-filter": "saturate(800%)", "-ms-filter": "saturate(800%)", "-o-filter": "saturate(800%)", "-moz-filter": "saturate(800%)" }),
                    a("body").attr("nl-colors", c),
                    b)
                )
                    return (
                        a(commons.dd + " > #NagishLiColors > li > #NLSaturateColors")
                            .attr("aria-label", phrases.aria_the_option + phrases.saturated + " " + phrases.r2m_on)
                            .prepend(commons.checkmark)
                            .parent("li")
                            .addClass("active")
                            .siblings("li")
        ...
        function v(b, c, d, e, l) {
            ...
            d
                ? (a("body").attr("nl-colors", "custom"),
                  ...
                  "bg" == b
                      ? ((b = "he" == g ? ("undefined" !== typeof d[h(c)] ? phrases.bg + " " + d[h(c)] : d.custom) : "undefined" !== typeof d[h(c)] ? d[h(c)] + " " + phrases.bg.toLowerCase() : d.custom),
                        a("*")
                            .not(commons.not)
                            .each(function () {
                        ...
                        a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG")
                            ...
                            .attr("aria-label", b))
                      : ((b = "he" == g ? ("undefined" !== typeof d[h(c)] ? phrases.txt + " " + d[h(c)] : d.custom) : "undefined" !== typeof d[h(c)] ? d[h(c)] + " " + phrases.txt.toLowerCase() : d.custom),
                        a("*")
                            .not(commons.not)
                            .each(function () {
                        ...
                        a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsTXT > #NLCurrentTXT")
                            .css({ "background-color": c, display: "inline-block" })
                            .attr("aria-label", b)),
                  a("div#NLCustomColors").children("span.sign").length ||
                      ...
                      a(commons.dd + " > #NagishLiColors")
                          .prev("div.nl-dropdown-toggle")
                          .hasClass("open") ||
                          a('<span class="selected">' + phrases.custom_colors + "</span>").insertAfter(
                              a(commons.dd + " > #NagishLiColors")
                                  .prev("div", ".nl-dropdown-toggle")
                                  .children(".nl-dropdown-title")
                          )))
                : a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel > li.selected").length
                ? ("custom" != a("body").attr("nl-colors") && (a("html").css("height", ""), a(":root").css({ filter: "", "-webkit-filter": "", "-moz-filter": "", "-khtml-filter": "", "-ms-filter": "", "-o-filter": "" })),
                  a("body").attr("nl-colors", "custom"),
        ...
        function z(b) {
            ...
            "custom" == a("body").attr("nl-colors")
                ? (a("*")
                  ...
                  a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG, " + commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsTXT > #NLCurrentTXT")
                  ...
                  a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.clr_custom + "']")
                      ...
                      .attr("aria-label", phrases.aria_select_txtcolor)
                      .css("color", a("body").css("color")))
                : (a("html").css("height", ""), a(":root").css({ filter: "", "-webkit-filter": "", "-moz-filter": "", "-khtml-filter": "", "-ms-filter": "", "-o-filter": "" }), a("nagishli > style#NagishLiPseudoStyling").remove());
        ...
        function R(b) {
            (void 0 === b ? 0 : b)
                ? (a(commons.dd + " > #NagishLiText > li > #NLNormalText")
                      ...
                      .remove(),
                  (b = f("read", "text")))
                : ((b = 16 != parseInt(a("body").css("font-size")) ? parseInt(a("body").css("font-size")) : 16), (b += 1));
            var c = b;
            a("*")
                .not(commons.not)
                .each(function () {
                    for (var b = a(this).length; b--; ) {
                        var current_size = parseFloat($(a(this)[b]).css("font-size"))
                        c = Math.round(1.1 * current_size)
        ...
        function S(b) {
            (void 0 === b ? 0 : b)
                ? (a(commons.dd + " > #NagishLiText > li > #NLNormalText")
                      ...
                      .remove(),
                  (b = f("read", "text")))
                : ((b = 16 != parseInt(a("body").css("font-size")) ? parseInt(a("body").css("font-size")) : 16), --b);
            var c = Math.max(0, b);
            a("*")
                .not(commons.not)
                .each(function () {
            ...
            if (b)
                return (
                    a("" + commons.dd + " > #NagishLiDisplay > li > #NLTextDisplay")
                        .attr("aria-label", phrases.aria_the_option + phrases.text_only + " " + phrases.r2m_on)
                        .prepend(commons.checkmark)
                        .parent("li")
                        .addClass("active")
                        .siblings("li")
        ...
        function aa(b, c) {
            "images" != a("body").attr("nl-display")
                ? (a("body").attr("nl-display", "images"),
                  ...
                  (c = "imagesonly"))
                : (a("body").removeAttr("nl-display"), a("body > *").not("#NagishLiBar").css("visibility", ""), a("body > .fb-like").css("display", ""), (c = "normal"));
            if (b)
                return (
                    a(commons.dd + " > #NagishLiDisplay > li > #NLImagesDisplay")
                        .attr("aria-label", phrases.aria_the_option + phrases.images_only + " " + phrases.r2m_on)
                        .prepend(commons.checkmark)
                        .parent("li")
                        .addClass("active")
                        .siblings("li")
        ...
        function ba(b) {
            ...
            a("body[nl-display]").length &&
                ...
                a("link[rel='stylesheet']").prop("disabled") && a("link[rel='stylesheet']").prop("disabled", !1),
                a("body > *, img, iframe[src*='youtube.com'], video").css({ display: "", visibility: "" }),
                a("body").css("background-image", ""),
                f("change", "display", b));
        }
        function T(b) {
            b
                ? (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks")
                      .attr("aria-label", phrases.aria_the_option + phrases.hl_links + " " + phrases.r2m_on)
                      .prepend(commons.checkmark)
                      .parent("li")
                      .addClass("active"),
                  a("* a")
                ...
                : (a("body[nl-hl-links]").length
                      ? (a("* a")
                        ...
                        a("body[nl-hl-headings]").length &&
                            a("h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, h1 span, h2 span, h3 span, h4 span, h5 span, h6 span").each(function () {
        ...
        function U(b) {
            b
                ? (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightHeadings")
                      .attr("aria-label", phrases.aria_the_option + phrases.hl_headings + " " + phrases.r2m_on)
                      .prepend(commons.checkmark)
                      .parent("li")
                      .addClass("active"),
        ...
        function ca(b) {
            if ("zoom" in document.documentElement.style)
                b
                    ? ((b = f("read", "zoom")), (b = +b))
                    : ((b = a("body[style*='zoom']").length ? (-1 !== a("body").css("zoom").indexOf("%") ? parseInt(a("body").css("zoom")) / 100 : parseFloat(a("body").css("zoom"))) : 1), (b = +(b + 0.1).toFixed(1))),
                    a("body").css("zoom", b),
                    a("body > iframe").css({
            ...
            if (a("body[nl-r2m]").length || a("body span.r2m").length || "off" != c)
                ...
                var d = function (b, c) {
                    ...
                    l =
                        ...
                        '" /></span>';
                X ||
                    (!b && (a(commons.bar + " > #nlr2mp").length || a(commons.bar + " > #nlr2ms").length)) ||
                ...
                a("span.r2m > img").click(function (b) {
                    ...
                    if (X)
                        (b = new SpeechSynthesisUtterance()),
                            (b.lang = "en"),
                            pa ? ((b.pitch = 0.7), (b.rate = 0.7)) : ((b.pitch = 1), (b.rate = 0.7 - 0.2)),
                    ...
                    "black" == b
                        ? a(commons.checkmark).prependTo(
                              a(commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorBlack")
                                  .attr("aria-label", phrases.aria_the_option + phrases.cursor + " " + phrases.cursor_black + " " + phrases.r2m_on)
                                  .addClass("active")
                          )
                        : a(commons.checkmark).prependTo(
                              a(commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorWhite")
                                  .attr("aria-label", phrases.aria_the_option + phrases.cursor + " " + phrases.cursor_white + " " + phrases.r2m_on)
                                  .addClass("active")
                          ),
                    !1
                );
        ...
        function ja() {
            a(commons.dd + " > .nl-dropdown-toggle.open").length
                ? a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus").attr({ class: "collapse-all", "aria-label": phrases.collapse_all })
                : a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus").attr({ class: "expand-all", "aria-label": phrases.expand_all });
        }
        function V(b, c) {
            b = void 0 === b ? !1 : b;
            c = void 0 === c ? "1" : c;
            a(commons.dd + " > #NagishLiInfo > #NagishLiHelp").hasClass("active")
                ? (a(commons.dd + " > #NagishLiInfo > #NagishLiHelp")
                  ...
                  a(commons.dd + " > .nl-dropdown-menu > li > div")
                      ...
                      .hide(),
                  a(commons.dd + " > .nl-dropdown-menu > li > div > span.nagishli-option-title, " + commons.menus + " > li > div > span.nl-dropdown-title, " + commons.dd + " > .nl-dropdown-toggle > .nl-dropdown-arrow").attr(
                      "aria-hidden",
                      "false"
                  ),
                ...
                : (a(commons.checkmark).prependTo(
                      a(commons.dd + " > #NagishLiInfo > #NagishLiHelp")
                          .attr("aria-label", phrases.aria_the_option + phrases.help + " " + phrases.r2m_on)
                          .addClass("active")
                          .children("div")
                  ),
                  a(commons.dd + " > .nl-dropdown-menu > li > div")
                ...
                (a("iframe[src*='youtube.com']").each(function () {
                    for (var b = a(this).length; b--; )
                        "ytmedia" == a(this).attr("nl-role")
                            ? (a("iframe[src*='youtube.com']")[b].contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), a(this).attr("nl-role", "ytmedia-paused"))
                            : a(this).attr("nl-role", "ytmedia");
                }),
                a("video, audio").each(function () {
                    for (var b = a(this).length; b--; ) "media" == a(this).attr("nl-role") ? (a("video, audio")[b].pause(), a(this).attr("nl-role", "media-paused")) : a(this).attr("nl-role", "media");
                }));
        }
        ...
        !(function (a, c) {
            ...
            function g(a, b, c) {
                if (b.scope === c || "all" === b.scope) {
                    ...
                    ((0 !== b.mods.length || t[16] || t[18] || t[17] || t[91]) && !c && "*" !== b.shortcut) ||
                        (!1 === b.method(a, b) && (a.preventDefault ? a.preventDefault() : (a.returnValue = !1), a.stopPropagation && a.stopPropagation(), a.cancelBubble && (a.cancelBubble = !0)));
                }
            }
            function h(a) {
                var b = r["*"],
            ...
            function m(b, e, f) {
                ...
                for ("string" == typeof e && (F = e); k < l.length; k++)
                    (g = []),
                        ...
                        r[b].push({ keyup: n, keydown: E, scope: F, mods: g, shortcut: l[k], method: f, key: l[k] });
                void 0 === B ||
                    -1 < w.indexOf(B) ||
                    !window ||
                    (w.push(B),
                    ...
                    a(B, "keyup", function (a) {
                        ...
                        var b = a.keyCode || a.which || a.charCode,
                            c = p.indexOf(b);
                        if ((0 > c || p.splice(c, 1), a.key && "meta" == a.key.toLowerCase() && p.splice(0, p.length), (93 !== b && 224 !== b) || (b = 91), b in t)) for (var d in ((t[b] = !1), q)) q[d] === b && (m[d] = !1);
                    }));
            }
            for (
                var k = "undefined" != typeof navigator && 0 < navigator.userAgent.toLowerCase().indexOf("firefox"),
                    u = {
                        backspace: 8,
                        tab: 9,
                        clear: 12,
                    ...
                    q = { "\u21e7": 16, shift: 16, "\u2325": 18, alt: 18, option: 18, "\u2303": 17, ctrl: 17, control: 17, "\u2318": k ? 224 : 91, cmd: k ? 224 : 91, command: k ? 224 : 91 },
        ...
        d +=
            ...
            phrases.a11y_title +
            "</span>" +
            (H ? "" : '<span id="NagishLiToggleMenus" class="expand-all" tabindex="6" aria-label="' + phrases.expand_all + '" style="background: ' + icons.toggle_all + ';"></span>');
        ...
        if (null != a("body").css("background-color") || null != a("body").css("color"))
            (d += '<li class="not-clickable">'),
                (d +=
                    ...
                    "</span>:&nbsp;" +
                    (null != a("body").css("background-color") && "rgba(0, 0, 0, 0)" != a("body").css("background-color")
                        ? '<span id="NLCustomColorsBG" tabindex="35"><span id="NLCurrentBG" style="display: none;"></span>' + phrases.bg + "</span>&nbsp;"
                        : "") +
                    (null != a("body").css("color") && "rgba(0, 0, 0, 0)" != a("body").css("color")
                        ? '<span id="NLCustomColorsTXT" tabindex="35"><span id="NLCurrentTXT" style="display: none;"></span>' + phrases.txt + "</span></div>"
                        : "")),
                (d += "</li>");
        d += '<li class="active">';
        ...
        e +=
            commons.menus + ".green > .nl-dropdown > .nl-dropdown-toggle:hover, " + commons.menus + ".green::-webkit-scrollbar-thumb:active, #NagishLiOverlayContent.green::-webkit-scrollbar-thumb:active { background: #365E1B !important; }";
        ...
        e +=
            commons.menus + ".brown > .nl-dropdown > .nl-dropdown-toggle:hover, " + commons.menus + ".brown::-webkit-scrollbar-thumb:active, #NagishLiOverlayContent.brown::-webkit-scrollbar-thumb:active { background: #A96342 !important; }";
        ...
        e +=
            commons.menus + ".black > .nl-dropdown > .nl-dropdown-toggle:hover, " + commons.menus + ".black::-webkit-scrollbar-thumb:active, #NagishLiOverlayContent.black::-webkit-scrollbar-thumb:active { background: #242424 !important; }";
        ...
        H
            ? ((e += commons.bar + " > #NagishLiBarStrip.open > #NagishLiMove { margin-" + phrases.align_left + ": 0 !important; }"),
              (e += commons.bar + " > #NagishLiBarStrip > #NagishLiMove { margin-" + phrases.align_right + ": 10px !important; }"))
            : (e += commons.bar + " > #NagishLiBarStrip.open > #NagishLiMove { margin-" + phrases.align_left + ": 30px !important; }");
        na &&
            ((e += commons.bar + " > #NagishLiBarStrip > #NagishLiTitle, " + commons.bar + " > #NagishLiBarStrip > #NagishLiMove, " + commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus  { display: none !important; }"),
            (e +=
                commons.bar +
        ...
        hotkeys("alt+z, alt+x, alt+v, alt+b, shift+z, shift+x, shift+a, shift+s, shift+q, shift+w, shift+e, shift+d, shift+f", function (b, c) {
            if ("alt+z" == c.key || "shift+z" == c.key) {
                ...
                "alt+x" == c.key || "shift+x" == c.key
                    ...
                    ? window.scrollTo(0, "alt+v" == c.key ? 0 : (document.scrollingElement || document.body).scrollHeight)
                    : "shift+a" == c.key
                    ? R()
                    : "shift+s" == c.key
                    ? S()
                    : "shift+q" == c.key
                    ? (m(),
                      a(commons.dd + " > #NagishLiColors > li > #NLGrayscaleColors > .sign").length
                          ? (a(commons.dd + " > #NagishLiColors > li > #NLGrayscaleColors > .sign").remove(),
                    ...
                    ? (k(),
                      a(commons.dd + " > #NagishLiColors > li > #NLInvertColors > .sign").length
                          ? (a(commons.dd + " > #NagishLiColors > li > #NLInvertColors > .sign").remove(),
                            a(commons.dd + " > #NagishLiColors > li.active").removeClass("active"),
                            a(commons.dd + " > #NagishLiColors > li > #NLNormalColors")
                                .addClass("active")
                                .prepend(commons.checkmark),
                    ...
                    : "shift+e" == c.key
                    ? (p(),
                      a(commons.dd + " > #NagishLiColors > li > #NLSaturateColors > .sign").length
                          ? (a(commons.dd + " > #NagishLiColors > li > #NLSaturateColors > .sign").remove(),
                            a(commons.dd + " > #NagishLiColors > li.active").removeClass("active"),
                            a(commons.dd + " > #NagishLiColors > li > #NLNormalColors")
                                .addClass("active")
                                .prepend(commons.checkmark),
                    ...
                    : "shift+d" == c.key
                    ? (T(),
                      a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks > .sign").length
                          ? (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks > .sign").remove(),
                          ...
                          : (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightLinks")
                            ...
                            a(commons.dd + " > #NagishLiHighlight")
                                ...
                                a(commons.dd + " > #NagishLiHighlight")
                                    .prev("div.nl-dropdown-toggle")
                                    .children(".selected").length ||
                                a('<span class="selected">' + phrases.hl_links + "</span>").insertAfter(
                                    a(commons.dd + " > #NagishLiHighlight")
                                        .prev("div", ".nl-dropdown-toggle")
                                        .children(".nl-dropdown-title")
                                )))
                    : "shift+f" == c.key &&
                      (U(),
                      a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightHeadings > .sign").length
                          ? (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightHeadings > .sign").remove(),
                            a(commons.dd + " > #NagishLiHighlight > li.active").removeClass("active"),
                            a(commons.dd + " > #NagishLiHighlight")
                                .prev("div.nl-dropdown-toggle")
                                .children(".selected")
                          ...
                          : (a(commons.dd + " > #NagishLiHighlight > li > #NLHighlightHeadings")
                            ...
                            a(commons.dd + " > #NagishLiHighlight")
                                ...
                                a(commons.dd + " > #NagishLiHighlight")
                                    .prev("div.nl-dropdown-toggle")
                                    .children(".selected").length ||
                                a('<span class="selected">' + phrases.hl_headings + "</span>").insertAfter(
                                    a(commons.dd + " > #NagishLiHighlight")
                                        .prev("div", ".nl-dropdown-toggle")
                                        .children(".nl-dropdown-title")
                                )));
        ...
        A
            ? (function () {
                  var b = f("read", "ok"),
                      ...
                      t = f("read", "tabbing"),
                      r = f("read", "r2m");
                  if ("0" == b && (("0" != e && (8 >= parseInt(e) || 35 <= parseInt(e))) || ("0.0" != h && (0.5 >= parseFloat(h) || 2.5 <= parseFloat(h))) || (-1 !== c.indexOf(",") && c.split(",")[0] == c.split(",")[1]))) {
                  ...
                  "grayscale" == c
                      ...
                      ? p(!0)
                      : -1 !== c.indexOf(",")
                      ? ("-" != c.split(",")[0] && v("bg", W(c.split(",")[0]), !0), "-" != c.split(",")[1] && v("txt", W(c.split(",")[1]), !0))
                      : z();
                  ...
                  !a("ul#NagishLiHighlight").prev(".nl-dropdown-toggle", "div").hasClass("open") &&
                      ...
                      (1 < a("ul#NagishLiHighlight > li.active").find("span.sign").length
                          ? ((c = a("ul#NagishLiHighlight").children("li.active:first-child").find(".nagishli-option-title").text() + " " + a("ul#NagishLiHighlight").children("li.active:nth-child(2)").find(".nagishli-option-title").text()),
                            (c = c.split(" ")),
                            (c[1] = "en" == g ? c[1].charAt(0).toUpperCase() + c[1].substr(1) : c[1]),
                            a('<span class="selected">' + c[1] + "&nbsp;" + phrases.and + c[3] + "</span>").insertAfter(a("ul#NagishLiHighlight").prev(".nl-dropdown-toggle", "div").children(".nl-dropdown-title")))
                          : ((c = a("ul#NagishLiHighlight > li.active").find(".nagishli-option-title").text()),
        ...
        a("body").on("mousedown keypress.nlkbnavclk", function (b) {
            !a(commons.menus).is(":visible") ||
                a(b.target).is("#NagishLiBar, .NagishLiOverlay, a, span[nl-r2m-data], #NLCustomColorsTXT, #NLCustomColorsBG, #NLCloseColorPanel") ||
                a(b.target).parents("#NagishLiBar, .NagishLiOverlay, a, span[nl-r2m-data]").length ||
                (a(commons.menus).slideUp(150, function () {
                    a(commons.bar + " > #NagishLiBarStrip").removeClass("open");
                }),
            ...
            (1 !== b.which && 13 !== b.which) ||
                ...
                (a(commons.menus).is(":visible")
                    ? (a(commons.menus).slideUp(150, function () {
                      ...
                      (c = "closed"))
                    : (a(this).addClass("open").next("#NagishLiMenus").slideDown(150), (c = "open")),
                f("change", "menu", c));
        });
                ...
                : (a(this).toggleClass("open").next("ul.nl-dropdown-menu").slideToggle("fast").toggleClass("show"),
                  a(this).hasClass("open")
                      ? ((b = "1"),
                        a(this)
                            .children(".nl-dropdown-arrow")
                            .attr("aria-label", phrases.aria_toggle_close_alt + a(this).children(".nl-dropdown-title").text()),
                        a(this)
                            .children(".nagishli-sr-only")
                            .text(phrases.aria_toggle_close_alt + a(this).children(".nl-dropdown-title").text()))
                      : ((b = "0"),
                        a(this)
                            .children(".nl-dropdown-arrow")
                            .attr("aria-label", phrases.aria_toggle_open_alt + a(this).children(".nl-dropdown-title").text()),
                        a(this)
                            .children(".nagishli-sr-only")
                            .text(phrases.aria_toggle_open_alt + a(this).children(".nl-dropdown-title").text())),
        ...
        a(commons.bar + " > #NagishLiBarStrip > #NagishLiToggleMenus").on("click keypress.nlkbnavclk", function (b, c) {
            !a(b.target).parent("span#NagishLiToggleMenus") ||
                ...
                (a(this).hasClass("expand-all")
                    ? (a(this).attr({ class: "collapse-all", "aria-label": phrases.collapse_all }),
                      a(commons.dd + " > .nl-dropdown-toggle")
                          .addClass("open")
        ...
        a(commons.dd + " > ul > li > div > span.help, " + commons.dd + " > ul > li > div > span.notice")
        ...
        a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > span:not(.sign, .help, .nagishli-option-title)").click(function () {
            ...
            "he" == g
                ? (e +=
                      ...
                      '"></li>' +
                      f)
                : ((e += c + " " + phrases.color + ':<ul id="NLcolorPanel" data-type="' + c + '" style="padding: 0 !important; text-align: center !important;">'),
                  (c = c.toLowerCase()),
                  (e +=
            ...
            "none" != b.css("display") &&
                (a(commons.checkmark).prependTo(a("div#NLCustomColors")),
                a(commons.dd + ' > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel > li[style="background-color: ' + h(b.css("background-color")) + ';"]').length
                    ? a(commons.dd + ' > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel > li[style="background-color: ' + h(b.css("background-color")) + ';"]')
                          .eq(0)
                          .addClass("selected")
                    : (a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.bg + "'] > li[aria-label='" + phrases.aria_select_bgcolor + "'] > input#NLColorPicker")
                          .attr("value", h(b.css("background-color")))
                          .parent("li")
                          .attr("aria-label", phrases.clr_custom)
                          .addClass("selected"),
                      a(commons.dd + " > #NagishLiColors > li.not-clickable > #NLCustomColors > ul#NLcolorPanel[data-type='" + phrases.txt + "'] > li[aria-label='" + phrases.aria_select_txtcolor + "'] > input#NLColorPicker")
                          .attr("value", h(b.css("background-color")))
                          .parent("li")
                          .attr("aria-label", phrases.clr_custom)
                          .addClass("selected")));
            ...
            a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > ul > li#NLCloseColorPanel").on("click keypress.nlkbnavclk", function () {
                ...
                a(this).parent("ul#NLcolorPanel").data("type") === phrases.bg
                    ? (b.length
                          ? a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG")
                                .css({ "background-color": b.css("background-color"), display: "inline-block" })
                                .attr("aria-label", b.attr("aria-label"))
                          : a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsBG > #NLCurrentBG").css({ "background-color": "", display: "none" }),
                      a("body[nl-kbnav]").length && document.getElementById("NLCustomColorsBG").focus())
                    : (c.length
                          ? a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsTXT > #NLCurrentTXT")
                                .css({ "background-color": c.css("background-color"), display: "inline-block" })
                                .attr("aria-label", c.attr("aria-label"))
                          : a(commons.dd + " > #NagishLiColors > li > #NLCustomColors > #NLCustomColorsTXT > #NLCurrentTXT").css({ "background-color": "", display: "none" }),
                ...
                1 <= a("#NLCurrentBG:visible, #NLCurrentTXT:visible").length
                    ? a("div#NLCustomColors").children("span.sign").length || a(commons.checkmark).prependTo(a("div#NLCustomColors"))
                    : a("div#NLCustomColors").children("span.sign").remove();
            });
        });
        a(commons.dd + " > .nl-dropdown-toggle").click(function (b) {
            a(this).next("#NagishLiColors, #NagishLiDisplay", "ul").children("li.active:not(':last-child')").length
                ? !a(this).children("span.selected").length && a(this).next("ul").children("li.active").length
                    ? ((b = a(this).next("ul").children("li.active").find(".nagishli-option-title").text()), a('<span class="selected">' + b + "</span>").insertAfter(a(this).children(".nl-dropdown-title")))
                    : a(this).children("span.selected").remove()
                : a(this).next("#NagishLiHighlight", "ul").length &&
                  (!a(this).children("span.selected").length && 1 < a(this).next("ul").children("li.active").find("span.sign").length
                      ? ((b = a(this).next("ul").children("li.active:first-child").find(".nagishli-option-title").text() + " " + a(this).next("ul").children("li.active:nth-child(2)").find(".nagishli-option-title").text()),
                        (b = b.split(" ")),
                        (b[1] = "en" == g ? b[1].charAt(0).toUpperCase() + b[1].substr(1) : b[1]),
                        a('<span class="selected">' + b[1] + "&nbsp;" + phrases.and + b[3] + "</span>").insertAfter(a(this).children(".nl-dropdown-title")))
                      : !a(this).children("span.selected").length && a(this).next("ul").find("span.sign").length
                      ? ((b = a(this).next("ul").children("li.active").find(".nagishli-option-title").text()), a('<span class="selected">' + b + "</span>").insertAfter(a(this).children(".nl-dropdown-title")))
                      : a(this).children("span.selected").remove());
        });
                ...
                if (1 === b.which || 13 === b.which)
                    a(this).siblings("li:last").find("span.sign").remove(),
                        a(this).is(":first-child")
                            ? a('<span class="sign" aria-hidden="true">&nbsp;&nbsp;&#x2795;&#xfe0e;</span>').appendTo(a(this).children("div"))
        ...
        a(commons.dd + " > #NagishLiColors > li:not(.not-clickable), " + commons.dd + " > #NagishLiDisplay > li").click(function () {
            a(this).hasClass("active")
                ? (a(this).not("li:last-child").removeClass("active").find("span.sign").remove(), a(commons.checkmark).prependTo(a(this).siblings("li:last-child").addClass("active").children("div")))
        ...
        a(commons.dd + " > #NagishLiColors > li.not-clickable").on("click change keypress.nlkbnavclk", "#NLCustomColors > ul#NLcolorPanel > li:not(#NLCloseColorPanel)", function () {
            !a(this).hasClass("selected") || a(this).children("input").is("#NLColorPicker")
                ? (a(this).children("input").is("#NLColorPicker") && a(this).siblings("li.selected").length
                      ? a(this).removeClass("selected")
                      : a(this).addClass("selected").siblings("li").removeClass("selected").closest("li.not-clickable").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                  a(this).closest("div#NLCustomColors").children("span.sign").length || a(commons.checkmark).prependTo(a(this).closest("#NLCustomColors", "div")))
                : a(this).removeClass("selected").closest("#NLCustomColors", "div").find("span.sign").remove();
            a(this).attr("aria-label") != phrases.aria_select_bgcolor && a(this).attr("aria-label") != phrases.aria_select_txtcolor
                ? (a(this).siblings("li").removeClass("selected").closest("li.not-clickable").addClass("active").siblings("li").removeClass("active").find("span.sign").remove(),
                  a(this).children("input").is("#NLColorPicker")
                      ? a(this).addClass("selected").children("input#NLColorPicker").attr("value", a("#NLColorPicker").val())
                      : (a(this)
                        ...
                        a(this)
                            ...
                            .attr("aria-label", phrases.aria_select_txtcolor)
                            .css("background-color", "transparent")),
                  a(this).parent("ul#NLcolorPanel").data("type") === phrases.bg ? v() : v("txt"))
                : a(this).closest("div#NLCustomColors").children("span.sign").length && !a("body[nl-colors]").length && a(this).removeClass("selected").closest("#NLCustomColors", "div").find("span.sign").remove();
        ...
        a(commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorBlack, " + commons.dd + " > #NagishLiMisc > li > #NLCursor > #NLCursorWhite").click(function () {
            a(this).hasClass("active") ? a(this).removeClass("active").find("span.sign").remove() : (a(this).siblings("span").removeClass("active").find("span.sign").remove(), a(commons.checkmark).prependTo(a(this).addClass("active")));
        });
        a("span#NagishLiMove > span").each(function () {
        ...
        a(commons.dd + " > #NagishLiMisc > li > #NLSkipLinks > #NLSkipLinksVal").on("change", function () {
            ...
            if ("top" == b || "bottom" == b) window.scrollTo(0, "top" == b ? 0 : (document.scrollingElement || document.body).scrollHeight);
                ...
                var c;
                "menu" == b
                    ? (c = document.getElementsByTagName("nav")[0] || a("*[role='navigation']")[0] || a("ul li a")[0] || a("*[class*='menu']")[0] || a("*[id*='menu']")[0])
                    : "header" == b
                    ? (c =
                    ...
                    : "paragraph" == b
                    ? (c = document.getElementsByTagName("p")[0] || document.getElementsByTagName("body")[0])
                    : "content" == b &&
                      (c =
        ...
        document.getElementsByTagName("title")[0].length ||
            ((J = 0 < document.getElementsByTagName("h1").length ? document.getElementsByTagName("h1")[0] : phrases.untitled_page),
