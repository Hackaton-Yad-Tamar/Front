...
const RequestDialog: React.FC<RequestDialogProps> = ({ open, onClose, emergency: request }) => {
  ...
  // Hardcode data to match the image
  const emergencyData = {
    name: "גבריאל",
    location: "חיפה",
    description: "תאונת דרכים",
    severity: "חמור",
    responseStatus: "ממתין לתגובה",
    phone: "0501234578",
  };
    ...
    >
      ...
      <DialogContent
        sx={{
          ...
          padding: "10px 20px",
          backgroundColor: "#e1f5fe",
          maxHeight: "300px", // Keep the thinner height
          overflowY: "auto",
          "&::-webkit-scrollbar": {
            width: "6px",
          },
      ...
      >
        <Box sx={{ display: "flex", height: "100%" }}>
          ...
          <Box sx={{ flex: 1, paddingRight: "10px", fontFamily: "Rubik, sans-serif" }}>
            <Typography sx={{ color: "#00AEEE", fontFamily: "Rubik, sans-serif" }} variant="h6">
              "חירום עכשיו"
            </Typography>
            <Typography sx={{ color: "#324A6D", fontFamily: "Rubik, sans-serif" }}><strong>שם:</strong> גבריאל</Typography>
            <Typography sx={{ color: "#324A6D", fontFamily: "Rubik, sans-serif" }}><strong>אזור:</strong> חיפה</Typography>
            <Typography sx={{ color: "#324A6D", fontFamily: "Rubik, sans-serif" }}><strong>תיאור:</strong> תאונת דרכים</Typography>
            <Typography sx={{ color: "#324A6D", fontFamily: "Rubik, sans-serif" }}><strong>חומרה:</strong> חמור</Typography>
            <Typography sx={{ color: "#324A6D", fontFamily: "Rubik, sans-serif" }}><strong>סטטוס תגובה:</strong> ממתין לתגובה</Typography>
            
            <Typography sx={{ color: "#324A6D", fontFamily: "Rubik, sans-serif" }}>
              <strong>מספר טלפון:</strong> 0501234578
            </Typography>
          </Box>

          {/* Map on the right (50% width) */}
          <Box sx={{ flex: 1, height: "300px", pl: 1 }}>
            <div
              ref={mapRef}
              style={{
                width: "100%", // Set width to 70% as specified
                height: "100%", // Set height to 90% as specified
                borderRadius: "10px", // Add rounded corners
                borderColor: "white", // Set border color to white
                boxShadow: "10px 10px 10px rgba(0, 0, 0, 0.3)", // Add shadow
      ...
      <DialogActions
        sx={{
          justifyContent: "flex-end", // Keep buttons on the right (visually left in RTL)
          backgroundColor: "#e1f5fe",
          padding: "10px 20px",
        }}
      >
        ...
        <Button
          ...
          sx={{
            ...
            color: "white",
            borderRadius: "20px",
            marginRight: "6px", // Maintain space between buttons
            "&:hover": {
